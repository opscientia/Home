...
import { MdArrowDownward, MdArrowUpward, MdExpandMore } from "react-icons/md";
...
const Faq = () => {
  ...
  const faq1Tog = () => {
    $(".faq1Box").slideToggle(750);
    $(".faq1Head svg").toggleClass("rotateIcon");
  };
  const faq2Tog = () => {
    $(".faq2Box").slideToggle(750);
    $(".faq2Head svg").toggleClass("rotateIcon");
  };
  const faq3Tog = () => {
    $(".faq3Box").slideToggle(750);
    $(".faq3Head svg").toggleClass("rotateIcon");
  };
  const faq4Tog = () => {
    $(".faq4Box").slideToggle(750);
    $(".faq4Head svg").toggleClass("rotateIcon");
  };
  return (
        ...
        <div className="box">
          <div className={stt.parallexBoxesParent}>
            ...
            <div className={st.faqSection}>
              <div
                className={st.faqHeading + " " + "faq1Head"}
                onClick={faq1Tog}
              >
                <span>
                  <h1>Technology </h1>
            ...
            <div className={st.faqSection}>
              <div
                className={st.faqHeading + " " + "faq2Head"}
                onClick={faq2Tog}
              >
                <span>
                  <h1>Data General </h1>
            ...
            <div className={st.faqSection}>
              <div
                className={st.faqHeading + " " + "faq3Head"}
                onClick={faq3Tog}
              >
                <span>
                  <h1>Human Data </h1>
              ...
              <div className="faq3Box">
                <Accordion className="faqAnim3">
                  <FaqBox
                    eventKey="0"
            ...
            <div className={st.faqSection}>
              <div
                className={st.faqHeading + " " + "faq4Head"}
                onClick={faq4Tog}
              >
                <span>
              ...
              <div className="faq4Box">
                <Accordion className="faqAnim4">
                  <FaqBox
                    eventKey="0"
